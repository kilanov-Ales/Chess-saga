...
const dict = {
    ...
    en: {
        ...
        guide_forge: "Scenario Forge", guide_forge_desc: "Here you forge your stories. Set name, tags, and goals. Making moves creates steps. Mark if a move completes a goal.",
    ...
    uk: {
        ...
        guide_forge: "Кузня Сценаріїв", guide_forge_desc: "Тут ви створюєте свої історії. Задайте ім'я, теги та цілі. Роблячи ходи на дошці, ви створюєте кроки. Обирайте в списку, яку ціль виконує хід.",
        ...
        guide_mail: "Вороняча Пошта", guide_mail_desc: "Чат правителів. Спілкуйтеся з іншими творцями. Лихослів'я карається Інквізицією.",
